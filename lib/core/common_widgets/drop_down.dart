...
Future<dynamic> diseasesBottomSheet(
    BuildContext context,
    Function(dynamic) onItemSelected,
    String bottomSheetTitle,
    List<dynamic> list,
  ...
  return showModalBottomSheet(
    context: context,
    isScrollControlled: false,
    builder: (c) => DiseasesBottomSheetContent(
      onItemSelected: onItemSelected,
      bottomSheetTitle: bottomSheetTitle,
      list: list,
      isVisible: isVisible,
...
class DiseasesBottomSheetContent extends StatefulWidget {
  final Function(dynamic) onItemSelected;
  final String bottomSheetTitle;
  final List<dynamic> list;
  final bool isVisible;

  const DiseasesBottomSheetContent({
    super.key,
    required this.onItemSelected,
    required this.bottomSheetTitle,
    required this.list,
  ...
  @override
  State<DiseasesBottomSheetContent> createState() =>
      DiseasesBottomSheetContentState();
}

class DiseasesBottomSheetContentState
    extends State<DiseasesBottomSheetContent> {
  int? selectedIndex;
  TextEditingController txtContro = TextEditingController();
...
Future<dynamic> commonReferredCampBottomSheet(
    BuildContext context,
    Function(dynamic) onItemSelected,
    String bottomSheetTitle,
    List<dynamic> list,
...
class _CommonReferredCampsBottomSheetContent extends StatefulWidget {
  ...
  @override
  State<_CommonReferredCampsBottomSheetContent> createState() =>
      _CommonReferredCampsBottomSheetContentState();
}

class _CommonReferredCampsBottomSheetContentState
    extends State<_CommonReferredCampsBottomSheetContent> {
  int? selectedIndex;
