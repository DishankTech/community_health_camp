class GetIDProofListResponseModel {
  int? code;
  String? status;
  List<Data>? data;

  GetIDProofListResponseModel({this.code, this.status, this.data});

  GetIDProofListResponseModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
