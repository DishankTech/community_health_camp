class GetViralLoadStatusResponseModel {
  int? code;
  String? status;
  List<Data>? data;

  GetViralLoadStatusResponseModel({this.code, this.status, this.data});

  GetViralLoadStatusResponseModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
