        ...
        child: Column(
          children: [
            mAppBarV1(
              ...
              isSearched: locationMasterController.isSearch,
              suffix: Row(
                children: [
                  Visibility(
                    visible: locationMasterController.isSearch == false,
                    child: Material(
              ...
              searchWidget: Container(
                ...
                child: TextField(
                  controller: locationMasterController.searchController,
                  onChanged: (value) async {
                    await locationMasterController.getSearchedData(value);
                  },
                ...
                builder: (controller) {
                  return locationMasterController.hasInternet
                      ? controller.isLoading
                          ...
                          : Expanded(
                              child:
                                  (locationMasterController.searchedDataModel ==
                                          null)
                                      ? PagedListView<int, LocationListData>(
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          text:
                                                                            ...
                                                                            children: [
                                                                              TextSpan(text: item.districtDesEn.toString(), style: TextStyle(fontSize: responsiveFont(12), color: kTextColor, fontWeight: FontWeight.normal))
                                                                            ],
                                                                          ),
                                                                        ),
                                                                      ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          text:
                                                                            ...
                                                                            style: TextStyle(
                                                                                ...
                                                                                fontWeight: FontWeight.bold),
                                                                            children: [
                                                                              TextSpan(text: item.cityDescEn.toString(), style: TextStyle(fontSize: responsiveFont(12), color: kTextColor, fontWeight: FontWeight.normal))
                                                                            ],
                                                                          ),
                                                                        ),
                                                                      ),
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                              text: controller.searchedDataModel?.details?[index].districtDescEn.toString(),
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                              text: controller.searchedDataModel?.details?[index].cityDescEn.toString(),
                                                                              style: TextStyle(fontSize: responsiveFont(12), color: kTextColor, fontWeight: FontWeight.normal))
                                                                        ],
                                                                      ),
                                                                    ),
