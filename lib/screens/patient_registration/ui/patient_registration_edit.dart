...
class _PatientRegistrationEditScreenState
  ...
  checkInternetAndLoadData() async {
    ...
    if (doctorDeskController.hasInternet) {
      ...
      debugPrint("getPatientDetailsById Called");
    }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<DoctorDeskController>(
        ...
        builder: (controller) {
          if (controller.isLoading) {
            ...
            return BlocListener<PatientRegistrationBloc,
              ...
              child: BlocListener<MasterDataBloc, MasterDataState>(
                listener: (context, state) {
                  ...
                  if (state
                      .getStakeholderSubTypeWithLookupCodeStatus.isSuccess) {
